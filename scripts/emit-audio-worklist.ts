 ...
 *
 * Example:
 *   npx tsx scripts/emit-audio-worklist.ts /tmp/ch01src/supabase/content geo-ch01 \
 *     resources-and-resource-planning:1 land-as-a-resource:2 soil-as-a-resource:3
 *
 * Writes:
...
function main() {
  ...
  // Human worklist, grouped by lang → course → lesson.
  const md: string[] = [];
